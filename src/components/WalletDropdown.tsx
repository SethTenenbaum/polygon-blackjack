  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="px-4 py-2 border-2 border-gray-300 hover:border-blue-500 rounded flex items-center gap-2 transition-colors bg-white font-medium text-sm"
      >
        {isConnected ? (
          <>
          ...
          {isConnected && address ? (
            ...
            <>
              ...
              <div className="px-4 py-3 border-b border-gray-200">
                ...
                <p className="text-xs text-gray-500 mt-1">Choose your wallet provider</p>
              </div>
